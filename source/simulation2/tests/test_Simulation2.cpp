...
public:
 TestDescription_suite_TestSimulation2_test_hotload_scripts() : CxxTest::RealTestDescription( Tests_TestSimulation2, suiteDescription_TestSimulation2, 134, "test_hotload_scripts" ) {}
